...
if __name__ == "__main__":
    ...
    def process_chunk(rows):
        """Example: Add a timestamp to each row"""
        import time
    ...
    print("Testing streaming CSV operations...")
    
    # Create test file
    test_file = "test_streaming.csv"
    ...
    print(f"Created test file with 5000 rows")
    
    # Test streaming update
    with streaming_csv_update(test_file, process_chunk, chunk_size=500) as processor:
        rows_processed = processor.process()
    ...
    with open(test_file, 'r') as f:
        ...
        print(f"First row after processing: {first_row}")
